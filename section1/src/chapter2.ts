// ----- 03. 타입스크립트의 타입 - 배열
let numArr: number[] = [1, 2, 3]; //number arr
let strArr: string[] = ["1", "2", "3"]; //string arr
let boolArr1: boolean[] = [true, false, true];
let boolArr2: Array<boolean> = [true, false, true]; //제네릭문법

// CASE :: 배열에 들어가는 요소들의 타입이 다양할 경우
let multiArr: (string | number)[] = ["string", 123];
