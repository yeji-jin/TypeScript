...
//(number | string | boolean) 유니언 타입: 각 요소는 셋 중 하나
//[] : 그 타입의 값들이 여러 개 들어가는 배열
// 여러 개의 number, string, boolean 중 아무거나 담을 수 있는 배열
 ...
 */
let abc: number & string; // number과 string타입의 교집합타입 ? 공집합 => never (불가능)
